const role_local_miner0 = {
    run: function(creep,the_source) {
    
        // const the_source = creep.room.source[0]
        const the_spawn = creep.room.spawn[1]
        const the_link = creep.room.link[1]
...
module.exports = role_local_miner0;